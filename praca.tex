...
\graphicspath{{fig/} {./fig/wykresy/} {./fig/schematy/}}
...
Tak się dzieje w przypadku spełnienia warunku gt (eng. greater then - większy niż) poprzedniej instrukcji cmp. Jednak jeżeli warunek ten nie zostaje spełniony to ewaluacja instrukji it zwiększa się do jednego cyklu i przechodzi do warunku then (druga instrukcja w kolejności).
...
\begin{table}
        ...
        \begin{tabularx}{\textwidth}{|c|c|X|}
                ...
                atm{TIME}\textbackslash n & TIME\textbackslash n& TIME to czas w milisekundach, jest on ustalany jako czas akwizycji licznika. \\ \hline
...
\begin{itemize}
        ...
        \item {Nazwa kanału}'\textbackslash t'{wynik}'\textbackslash n' -  przykład: \\
        1A1\quad 1234 \\
        1A2\quad 1234 \\
        \dots \\
        2A8\quad 1234
