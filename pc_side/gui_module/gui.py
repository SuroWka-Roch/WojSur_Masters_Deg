...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit_conf_data_loc.setText(_translate("MainWindow", os.path.dirname(__file__) + "\\data\\"))
        ...
        self.lineEdit_ss_file_loc.setText(_translate("MainWindow", os.path.dirname(__file__) + "\\data\\SingleShot\\"))
