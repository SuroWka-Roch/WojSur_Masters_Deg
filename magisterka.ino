...
void AKW_fun(char* commend){
  int volatile dummy; //needed to force compilator to not optymalize while loop
  ...
  noInterrupts(); 
    detachInterrupt(digitalPinToInterrupt(33)); // this function probably gonna add same time to counting thats why noInterupts space.
  interrupts();
